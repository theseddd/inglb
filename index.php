...
define('SERVICE_EMAIL', {อีเมลล์ในหน้า Service Account});
define('PATH_KEY12', {ที่อยู่ไฟล์ p12 ที่โหลดมา});
define('APPLICATION_NAME', {ชื่อแอพฯ ใส่อะไรก็ได้});
define('FILE_ID', {ID ของ Sheet ที่เราต้องการอ่าน});
// สร้าง Service Drive
